...
In this example we will deploy a Serenity bot with Shuttle that responds to the `/hello` command with `Hello there`. To run this bot we need a valid Discord Token. To get started log in to the [Discord developer portal](https://discord.com/developers/applications).
